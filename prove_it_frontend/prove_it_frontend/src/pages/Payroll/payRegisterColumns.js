...
export const COLUMNS = [
  ...
  { key: 'gross_salary_actual', header: 'Gross Salary', section: 'actual', type: 'number' },
  { key: 'basic_salary_actual', header: 'Basic Salary', section: 'actual', type: 'number' },
  { key: 'hra_actual', header: 'HRA', section: 'actual', type: 'number' },
  { key: 'cca_actual', header: 'CCA', section: 'actual', type: 'number' },
  { key: 'food_allowance_actual', header: 'Food Allowance', section: 'actual', type: 'number' },
  { key: 'transport_allowance_actual', header: 'Transport Allowance', section: 'actual', type: 'number' },
  { key: 'medical_allowances_actual', header: 'Medical Allowances', section: 'actual', type: 'number' },
  { key: 'monthly_bonus_actual', header: 'Monthly Bonus', section: 'actual', type: 'number' },
  { key: 'performance_incentive_actual', header: 'Performance Incentive', section: 'actual', type: 'number' },
  { key: 'arrears_actual', header: 'Arrears', section: 'actual', type: 'number' },
  { key: 'lta_ltc_actual', header: 'LTA/LTC', section: 'actual', type: 'number' },
  { key: 'professional_tax_actual', header: 'Professional Tax', section: 'actual', type: 'number' },
  { key: 'esi_actual', header: 'ESI', section: 'actual', type: 'number' },
  { key: 'provident_fund_actual', header: 'Provident Fund', section: 'actual', type: 'number' },
  { key: 'tds_actual', header: 'TDS', section: 'actual', type: 'number' },
  { key: 'medical_actual', header: 'Medical', section: 'actual', type: 'number' },
  { key: 'advance_actual', header: 'Advance', section: 'actual', type: 'number' },
  { key: 'net_salary_actual', header: 'Net Salary', section: 'actual', type: 'number' },
  { key: 'salary_for_hra_exempt_actual', header: 'Salary for HRA Exempt', section: 'actual', type: 'number' },
  { key: 'business_bonus_actual', header: 'Business Bonus', section: 'actual', type: 'number' },
  { key: 'gross_earning_actual', header: 'Gross Earning', section: 'actual', type: 'number' },
